        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 py-4 sm:pt-0" style="margin-top: 5px;">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8" style="margin-top: 5px;">
                ...
                <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg text-center" style="padding-bottom: 20px; padding-top: 20px" style="padding-bottom: 20px; padding-bottom: 20px;">
                    <a href="{{ route('Lenses.Store_1_56_HMC_55mm_SPH') }}"><img src="{{ asset('resources/photo/Degrees/SPH.png') }}" alt="Optilux Logo" style="border-radius: 35%; width: 30%; height: 30%;"></a>
                    <br>
                    <a href="{{ route('Lenses.Store_1_56_HMC_55mm_CYL_0_25_2_00') }}"><img src="{{ asset('resources/photo/Degrees/CYL_0.25_2.00.png') }}" alt="Optilux Logo" style="border-radius: 35%; width: 30%; height: 30%;"></a>
                    <a href="{{ route('Lenses.Store_1_56_HMC_55mm_CYL_2_25_3_00') }}"><img src="{{ asset('resources/photo/Degrees/CYL_2.25_3.00.png') }}" alt="Optilux Logo" style="border-radius: 35%; width: 30%; height: 30%;"></a>
                    <a href="{{ route('Lenses.Store_1_56_HMC_55mm_CYL_3_25_4_00') }}"><img src="{{ asset('resources/photo/Degrees/CYL_3.25_4.00.png') }}" alt="Optilux Logo" style="border-radius: 35%; width: 30%; height: 30%;"></a>
                    <a href="{{ route('Lenses.Store_1_56_HMC_55mm_CYL_4_25_6_00') }}"><img src="{{ asset('resources/photo/Degrees/CYL_4.25_6.00.png') }}" alt="Optilux Logo" style="border-radius: 35%; width: 30%; height: 30%;"></a>
