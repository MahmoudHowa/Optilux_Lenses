...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased dark:bg-gray-900">
        @include('Header')
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 py-4 sm:pt-0" style="margin-top: 5px;">
            {{--  @if (Route::has('login'))
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8" style="margin-top: 5px;">
                ...
                <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg text-center" style="padding-bottom: 20px; padding-top: 20px">
                    <a href="{{ route('Lenses.Store_1_67_BCC_HMC_70_65mm_SPH') }}"><img src="{{ asset('resources/photo/Degrees/SPH.png') }}" alt="Optilux Logo" style="border-radius: 35%; width: 30%; height: 30%;"></a>
                    <br>
                    <a href="{{ route('Lenses.Store_1_67_BCC_HMC_70_65mm_CYL_0_25_2_00') }}"><img src="{{ asset('resources/photo/Degrees/CYL_0.25_2.00.png') }}" alt="Optilux Logo" style="border-radius: 35%; width: 30%; height: 30%;"></a>
                    <a href="{{ route('Lenses.Store_1_67_BCC_HMC_70_65mm_CYL_2_25_3_00') }}"><img src="{{ asset('resources/photo/Degrees/CYL_2.25_3.00.png') }}" alt="Optilux Logo" style="border-radius: 35%; width: 30%; height: 30%;"></a>
                    <a href="{{ route('Lenses.Store_1_67_BCC_HMC_70_65mm_CYL_3_25_4_00') }}"><img src="{{ asset('resources/photo/Degrees/CYL_3.25_4.00.png') }}" alt="Optilux Logo" style="border-radius: 35%; width: 30%; height: 30%;"></a>
                    <a href="{{ route('Lenses.Store_1_67_BCC_HMC_70_65mm_CYL_4_25_6_00') }}"><img src="{{ asset('resources/photo/Degrees/CYL_4.25_6.00.png') }}" alt="Optilux Logo" style="border-radius: 35%; width: 30%; height: 30%;"></a>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2" >
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0">
                            <div class="flex items-center" style="direction: rtl">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;<div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laravel.com/docs" class="text-gray-900 dark:text-white">عـــد ســـات &nbsp لاصــقــة</a></div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm" style="direction: rtl; margin-right: 11%">
                                    تتخ هعارخعثصق خهلاقخل خثقلاخ ثقرخثق
                                </div>
                            </div>
                        </div>
                        </a>
